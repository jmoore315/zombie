...
(function() {
  $(document).ready(function() {
    var institution, paginationLoc, sidebar, theLoc;
    $('.dropdown-toggle').dropdown();
    $('.dropdown-menu, .dropdown-menu input, .dropdown-menu label').click(function(e) {
      return e.stopPropagation();
    });
    $('.sign_up_link').on('click', function(e) {
      return $('#signup_modal').modal('toggle');
    });
    $('.roommate_link').on('click', function(e) {
      return $('#roommate_account_create_modal').modal('toggle');
    });
    $('#bookmark-non-student').on('click', function(e) {
      return $('#bookmark-non-student-modal').modal('toggle');
    });
    $('#bookmark-no-account').on('click', function(e) {
      return $('#bookmark-no-account-modal').modal('toggle');
    });
    $('#send_button').on('click', function(e) {
      return $('#send_button').button('loading');
    });
    ...
    institution = $('.account_email').hasClass('Company') ? "company" : "school";
    ...
    $('.deactivate_link').on('click', function(e) {
      return $('#deactivate_modal').modal('toggle');
    });
    if ($('.rentals_sidebar').position() !== void 0) {
      sidebar = '.rentals_sidebar';
      theLoc = $(sidebar).position().top - 15;
      ...
      $(window).scroll(function() {
        if (theLoc >= $(window).scrollTop()) {
          ...
          if ($(sidebar).hasClass('fixed')) {
            ...
            return $(sidebar).css('margin-top', paginationLoc - 679);
          }
        } else {
          if (!$(sidebar).hasClass('fixed')) {
            if ($(sidebar).hasClass('sidebar-fixed-up')) {
              ...
              return $(sidebar).css('margin-top', -107);
            }
          }
        }
      });
    ...
    $('.faq a').on('click', function(e) {
      return $('#faq_modal').modal('toggle');
    });
    return $('.remoteform').on('change', function(e) {
      $(this.form).submit();
      $(".saved").hide();
      return $(".saving").fadeIn();
    });
  });

}).call(this);
(function() {
  this.render_contact_email = function(cssid) {
    var element, hostname, linktext, username;
    username = "contact";
    hostname = "uhoused.com";
    linktext = username + "@" + hostname;
    element = document.getElementById(cssid);
    return element.innerHTML = "<a href='" + "mail" + "to:" + username + "@" + hostname + "'>" + linktext + "</a>";
  };

}).call(this);
(function() {
  this.render_email_address = function(cssclass, user) {
    var element, emails, hostname, linktext, username, _i, _len, _results;
    username = user;
    hostname = "uhoused.com";
    linktext = username + "@" + hostname;
    emails = document.getElementsByClassName(cssclass);
    _results = [];
    for (_i = 0, _len = emails.length; _i < _len; _i += 1) {
      element = emails[_i];
      _results.push(element.innerHTML = "<a href='" + "mail" + "to:" + username + "@" + hostname + "'>" + linktext + "</a>");
    }
    return _results;
  };
